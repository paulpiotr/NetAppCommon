...
public class AppSettingsWithDatabase : AppSettingsWithoutDatabase
{
    ...
    #region public AppSettingsWithDatabase()
    ...
    #region public AppSettingsWithDatabase(string filePath)
    ...
    public int? CacheLifeTime
    {
        get
        {
            try
            {
                return _cacheLifeTime ??= AppSettingsRepository?.GetValue<int>(this, "CacheLifeTime");
            }
            catch (Exception e)
            {
                _log4Net.Error(
